...
@if_granta(granta._getGrantaWorkflowRecordGeneral)
@pydantic.validate_call
...
@if_granta(granta._getGrantaExecutionRecord)
@pydantic.validate_call
...
@if_granta(granta._getGrantaPendingExecutions)
...
@if_granta(granta._setGrantaExecutionParameter)
...
@if_granta(lambda eid: granta._setGrantaExecutionStatus(eid,'Scheduled'))
...
@if_granta(lambda eid: granta._setGrantaExecutionStatus(eid,'Ready'))
...
@if_granta(lambda eid: granta._setGrantaExecutionStatus(eid,'Running'))
...
@if_granta(lambda eid: granta._setGrantaExecutionStatus(eid,'Completed, to be reviewed'))
...
@if_granta(lambda eid: granta._setGrantaExecutionStatus(eid,'Failed'))
...
def insertIODataRecord(data):
    response = rPost("iodata/", data=json.dumps({"entity": data}))
    return response.json()
...
# Files
# --------------------------------------------------
@if_granta(granta._getGrantaBinaryFileByID)
...
@if_granta(granta._uploadGrantaBinaryFile)
